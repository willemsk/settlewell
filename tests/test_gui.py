...
# Safely import PySide6 & GUI modules, skipping cleanly if Qt backend conflicts or C-libraries are missing
try:
    ...
    pytest.skip(
        f"PySide6/Qt GUI dependencies or backend unavailable ({exc})",
